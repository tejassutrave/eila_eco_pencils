...
export default function DonateNewspapersPage() {
  ...
  const sqlSnippet = `-- SQL Schema for Eila Eco Products Newspaper Donations (Bilva Enterprise)
...
CREATE POLICY "Allow admin read donations"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      name="city"
                      required
                      placeholder="e.g. Dharwad / Hubli / Belagavi"
                      value={formData.city}
                      onChange={handleInputChange}
                      className="w-full px-3.5 py-2.5 bg-[#faf9f5] border border-[#e8e6da] rounded-xl focus:outline-none focus:border-[#2d6a4f]"
                    />
